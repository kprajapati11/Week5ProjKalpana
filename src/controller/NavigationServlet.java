	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(act.equals("delete")) {
			try {
				...
				ListStudent studentToDelete = dao.searchForStudentNameById(tempId);
			...
			try {
				Integer tempId = Integer.parseInt(request.getParameter("id"));
				ListStudent studentToEdit = dao.searchForStudentNameById(tempId);
				request.setAttribute("studentToEdit", studentToEdit);
				path = "/edit-student.jsp";
			}catch(NumberFormatException e) {
				System.out.println("Forgot to select student");
			}
